...
# Model Training and Evaluation Page
    ...
    smoker = st.slider("Smoker ---> 0 - No, 1 - Yes", min_value=0, max_value=1, value=1)
    stroke = st.slider("Stroke ---> 0 - No, 1 - Yes", min_value=0, max_value=1, value= 0)
    ...
    general_health = st.slider("General Health ---> 0 - No, 1 - Yes", min_value=0, max_value=5, value=3)
    mental_health = st.slider("Mental Health ---> 0 - No, 1 - Yes", min_value=0, max_value=30, value=10)
    physical_health = st.slider("Physical Health ---> 0 - No, 1 - Yes", min_value=0, max_value=30, value=10)
    difficulty_walking = st.slider("Difficulty Walking ---> 0 - No, 1 - Yes", min_value=0, max_value=1, value=1)
    sex = st.slider("Sex ---> 0 - Female, 1 - Male", min_value=0, max_value=1, value=1)
    age = st.slider("Age ---> 1 = 18-24, 2 = 25-29, 3 = 30-34, 4 = 35-39, 5 = 40-44, 6 = 45-49, 7 = 50-54, 8 = 55-59, 9 = 60-64, 10 = 65-69, 11 = 70-74, 12 = 75-79, 13 = 80 Or Older", min_value=1, max_value=13, value=7)
